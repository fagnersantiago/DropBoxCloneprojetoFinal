class DropBoxController {
    ...
    connectFireBase() {
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyAx2FOGDtesUtns-nXHTscPvOEA_5-9V5w",
            authDomain: "drop-box-clone-d0f78.firebaseapp.com",
            databaseURL: "https://drop-box-clone-d0f78.firebaseio.com",
            projectId: "drop-box-clone-d0f78",
            storageBucket: "drop-box-clone-d0f78.appspot.com",
            messagingSenderId: "390192496319",
            appId: "1:390192496319:web:be8638f3acbc74d928d00a",
            measurementId: "G-KCL23E431Q"
        };
    ...
    getSelection() {
        ...
        return this.listFileEl.querySelectorAll('li.selected');
    }
    ...
    formatTimeHuman(duration) {
        ...
        if (minute > 0) {
            ...
            return `${minute} minutos, ${second} segundos`
        }
        ...
        li.addEventListener('click', e => {
            ...
            if (e.shiftKey) {
                ...
                if (firstLi) {
                    ...
                    let indexStart;
                    let indexEnd;
                    let getLi = li.parentElement.childNodes

                    getLi.forEach((el, index) => {
